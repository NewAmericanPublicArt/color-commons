 ...
 * Loader functions for sunburst graphic, linked to INDEX.HTML
 * CREDITS: https://gist.github.com/mbostock/5944371
 */
 // GLOBAL VARS
...
d3.json("http://97.107.136.63:12345/serve", function(error, root) {
  ...
  partition
      ...
      .forEach(function(d) {
        ...
        d.sum = d.value;
        d.key = key(d);
        d.fill = d.msg ? colorize(d) : fill(d);
      });
